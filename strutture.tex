...
Sia S \le G un sottogruppo qualunque di G. Prendo a \in G e moltiplico tutti gli elementi di S per a.
...
Se \{a \cdot S\}_{a \in G} \`e una partizione di G, individua in G una relazione di equivalenza che chiamiamo % tilde preceduta da S
...
x equiv_sigma y \Leftrightarrow \exists n \in \mathbb{N} tc. y = \sigma^{n} (x)
